...
* `kubectl run kubernetes-bootcamp --image=jocatalin/kubernetes-bootcamp:v1 --port=8081` 创建
...
* `kubectl expose deploy kubernetes-bootcamp --type="NodePort" --target-port=8081 --port=8081`
