...
`````
./build/bin/mesos-master.sh --zk=zk://192.168.2.121:2181/mesos,192.168.2.40:2181/mesos,192.168.2.175:2181/mesos --port=5050 --log_dir=/var/log/mesos --cluster=test-cluster --quorum=2 --work_dir=/var/lib/mesos --ip=   &
